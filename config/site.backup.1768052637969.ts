...
export const siteConfig = {
    ...
    specialOffers: {
        enabled: true, // Возможность скрыть весь блок специальных предложений
        consultation: {
            enabled: true, // Возможность скрыть бесплатную консультацию
        ...
        packages: [
            {
                id: "health-package",
                enabled: true, // Возможность скрыть конкретный пакет
