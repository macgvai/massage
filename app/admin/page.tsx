...
export default function AdminPage() {
    ...
    window.addEventListener('imageUpdated', (...args) => {
        console.log('imageUpdated', args);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const json = await res.json();
            setSaveMessage(
                json.success ? '✅ Сохранено' : `❌ Ошибка: ${json.message}`,
            );
        } catch (e) {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <Container className="py-8">
                ...
                {activeTab === 'about' && (
                    <AboutTab config={config} updateConfig={updateConfig} />
                )}
                {activeTab === 'services' && (
                    <ServicesTab config={config} updateConfig={updateConfig} />
                )}
                {activeTab === 'offers' && (
                    <OffersTab config={config} updateConfig={updateConfig} />
                )}
