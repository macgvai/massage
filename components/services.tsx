import { formatPrice, formatDuration, getPackagePrice } from "@/lib/formatters";
...
export default function Services({ siteConfig }: { siteConfig: SiteConfig }) {
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900"
    >
      <Container>
        <SectionTitle
