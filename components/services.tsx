...
export default function Services({ siteConfig }: { siteConfig: SiteConfig }) {
    const services = siteConfig.services || [];
    const offers = siteConfig.specialOffers;
    
    const consultationOffers = offers?.consultation?.enabled ? [offers.consultation] : [];
    const packageOffers = offers?.packages?.filter(pkg => pkg.enabled) || [];
        ...
        <section id="services" className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-black dark:to-gray-900">
            <Container>
                <SectionTitle 
                    ...
                    subtitle="Профессиональные массажные услуги по честным ценам"
                >
                    Наши услуги и цены
                </SectionTitle>
                ...
                {offers?.enabled && (consultationOffers.length > 0 || packageOffers.length > 0) && (
                    <div className="mb-12">
                        <h3 className="text-2xl font-bold text-center mb-8 text-gray-900 dark:text-white">
                            🎁 Специальные предложения
                        </h3>
                        
                        {consultationOffers.map((consultation) => (
                            <div key="consultation" className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-2xl p-6 mb-8 border border-blue-200 dark:border-blue-800">
                                        ...
                                        <div className="text-center mb-4">
                                            ...
                                            {packageItem.savings && (
                                                <p className="text-emerald-600 dark:text-emerald-400 font-medium">
                                                    Экономия: {formatPrice(packageItem.savings)}
                                                </p>
                                            )}
