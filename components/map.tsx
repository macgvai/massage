...
export default function Map({ siteConfig }: { siteConfig: SiteConfig }) {
  const { coordinates, address, phone, workingHours, parking } = siteConfig.contact;
  const bbox = [
    ...
    <section id="map" className="py-16 bg-white dark:bg-gray-900">
      <Container>
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">📍 Как нас найти</h2>
          <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Мы находимся в удобном месте. Легко добраться на любом транспорте.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="relative">
            <div className="bg-gray-100 dark:bg-gray-800 rounded-2xl overflow-hidden shadow-lg">
              <div className="relative w-full h-96 lg:h-[400px]">
                <iframe
                  ...
                  title={`Карта расположения ${siteConfig.name}`}
                />
            ...
            <div className="mt-4 flex flex-col sm:flex-row gap-3 justify-center">
              <a
                href={`https://yandex.ru/maps/?ll=${coordinates.lng}%2C${coordinates.lat}&z=17&pt=${coordinates.lng}%2C${coordinates.lat}%2Cpm2rdm`}
                target="_blank"
          ...
          <div className="space-y-6">
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
              <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">📌 Адрес и контакты</h3>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${phone}`} className="text-green-600 dark:text-green-400 hover:underline">
                      {phone}
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300">{workingHours}</p>
                  </div>
                </div>
                ...
                {parking && (
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">{parking}</p>
                    </div>
                  </div>
                )}
              </div>
